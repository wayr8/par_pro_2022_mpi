...
TEST(Linear_Filtering_MPI, test3) {
    ...
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
    if (rank == 0) {
        a = {150, 128, 100, 200, 175, 100, 50,  250, 200, 255,
             0,   50,  75,  225, 130, 145, 200, 30,  230, 100};

        ans_seq = {130, 123, 145, 183, 196, 83,  98,  153, 196, 204,
                   67,  85,  130, 175, 172, 118, 132, 95,  172, 129};
    }
