...
#ifndef MODULES_TASK_3_USTINOV_A_MULTIPLE_INTEGRAL_MONTE_CARLO_MULTIPLE_INTEGRAL_MONTE_CARLO_H_
#define MODULES_TASK_3_USTINOV_A_MULTIPLE_INTEGRAL_MONTE_CARLO_MULTIPLE_INTEGRAL_MONTE_CARLO_H_
...
double multiple_integral_monte_carlo_sequential(
    ...
    std::array<double, dim> random_point;  // random point in rectangle
    std::mt19937_64 generator{std::random_device {}()};  // random number generator
    std::uniform_real_distribution<double> distribution(0.0, 1.0);
...
#endif  // MODULES_TASK_3_USTINOV_A_MULTIPLE_INTEGRAL_MONTE_CARLO_MULTIPLE_INTEGRAL_MONTE_CARLO_H_
