...
//    }
//
//    std::cout << first_str << " " << sec_str;
//    int parallelResult = doParallel(first_str, sec_str, length, 5);
//
//    if (myrank == 0) {
//        int sequentalResult = compareStrings(first_str, sec_str);
//        std::cout << " " << parallelResult << " " << sequentalResult;
//    }
//
//    MPI_Finalize();
//}
